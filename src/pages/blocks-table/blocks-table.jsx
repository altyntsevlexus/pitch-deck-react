...
import styled from './blocks-table.module.scss';
...
const BlocksTable = () => {
  ...
  return (
    <section className={`wrapper ${styled['blocks-table']}`}>
      <Logo />
      <div className={styled['blocks-table__overflow']}>
        <div className={styled['blocks-table__nav']}>
          <div>
            <p>Show items:</p>
