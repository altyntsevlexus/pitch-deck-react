  ...
  return (
    <section className="wrapper split-screen text-dark">
      <main className="split-screen__main">
        <Logo linkTo="marketing" />
        <div>
          <h1 className="fs-72 info-title">The Competition</h1>
          <ul className="info-list">
            <li className="info-list__item">
              <h2 className="fs-48 info-list__title">Company 1</h2>
              <p className="fs-34 info-list__description">Their reviews average 3.5, whereas we average 5 stars</p>
            </li>
            <li className="info-list__item">
      ...
      <img src={cornerImgR} alt="corner" className="corner-img corner-img--pos--r" />
    </section>
  );
};
